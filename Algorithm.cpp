...
int main() {
    ...
    copy(arr, arr + n, arr1);
    start = startTimer();
    optimizedBubbleSort(arr1, n, optimizedBubbleComparisons);
    ...
    copy(arr, arr + n, arr3);
    start = startTimer();
    basicBubbleSort(arr3, n, basicBubbleComparisons);
    ...
    copy(arr, arr + n, arr5);
    start = startTimer();
    cocktailSort(arr5, n, cocktailComparisons);
    ...
    copy(arr, arr + n, arr7);
    start = startTimer();
    recursiveBubbleSort(arr7, n, recursiveBubbleComparisons);
